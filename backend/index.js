...
// mongodb+srv://<username>:<password>@cluster0.sawkhzs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
// mongodb+srv://<username>:<password>@cluster0.sawkhzs.mongodb.net/
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.sawkhzs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
// this is same for users and classes change accordingly
        ...
        app.delete('/delete-user/:id',async (req, res) => {
         ...
         app.put('/update-user/:id', verifyAdmin , async (req, res) => {
            const id = req.params.id;
        ...
        app.patch('/change-status/:id', verifyAdmin,  async (req, res) => {
            const id = req.params.id;
        ...
        // Update a class
        app.put('/update-classes/:id',verifyInstructor, async (req, res) => {
            const id = req.params.id;
